...
<header class="header">
      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:donatered185@gmail.com" class="contact-link">donatered185@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+917558951351" class="contact-link">+91-90344-05780</a>
          </li>
        </ul>
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            Donate Red, Behind Civil Hospital, Near Old Bus Stand<br>
              Panipat, Haryana, IN <br> PIN: 132103
            </address>
          </a>
          </li>
          <li class="footer-item">
            ...
            <a href="tel:+91-90344-05780" class="footer-link">+91-90344-05780</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:donatered185@gmail.com" class="footer-link">donatered185@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; 2023 All Rights Reserved by Donate Red
        </p>
        <ul class="social-list">
